...
{
    public class AuthManager(UserManager<IdentityUser> userManager, IConfiguration
configuration) : IAuthManager
    ...
    public async Task<IEnumerable<IdentityError>> RegisterUtilisateur(RegisterModel
register)
        {
            IdentityUser user = new IdentityUser
            {
